          ...
          <div className="flex items-center">
            ...
            <div
              className={
                ...
                (step >= 2 ? (`border-teal-600`) : (`${themeMode ? ' border-gray-300':' border-white'}`))
              }
            ></div>
            <div className="flex items-center text-white relative">
              ...
              >
                <FaHandsHelping className={"text-xl" + (themeMode ? (` ${step >= 2? " text-white":"  text-gray-900"}`):" text-white")} />
              </div>
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600" >
                Approve
              </div>
              ...
              <div
                className={
                  ...
                  (step >= 3
                    ...
                    : (`${themeMode ? 'border-gray-300':' border-gray-300'}`))
                }
              >
                <GiConfirmed className={"text-xl" + (themeMode ? (` ${step >= 3 ? " text-white":"  text-gray-900"}`):" text-white")} />
              </div>
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600">
                Confirm
              </div>
